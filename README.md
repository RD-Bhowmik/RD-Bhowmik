...
- 🌱 Learning advanced **machine learning techniques** and **FastAPI optimization**
- 💼 Professional experience in **digital marketing** and **e-commerce operations**
- 🎓 Computer Science student with research interests in **AI** and **data science**
...
A comprehensive financial management web application for international students with real-time currency conversion across 19+ currencies.

**Tech Stack:** Python, Flask, PostgreSQL, Bootstrap 5, JavaScript  
**Key Features:**
- Real-time currency conversion with ExchangeRate API integration
- Secure user authentication with bcrypt
- Multi-currency financial tracking and analytics
...
Machine learning system predicting future disease profiles for 204 countries based on 30 years of mortality data.

**Tech Stack:** Python, Pandas, Scikit-learn, Matplotlib, Jupyter Notebook  
**Key Features:**
- Random Forest classification with 63.4% accuracy
- Processed 1.47 billion death records
- Feature engineering with 8 temporal features
...
AI-powered personal assistant for task automation and voice interaction.

**Tech Stack:** Python, Speech Recognition, AI/ML libraries  
**Key Features:**
...
### 🏘️ [UniNest](https://github.com/RD-Bhowmik/uninest)
Student housing and accommodation platform connecting students with verified listings.
...
### 😷 [Masked Face Detector](https://github.com/RD-Bhowmik/maskedface_detector)
Computer vision project for real-time face mask detection using deep learning.
...
#### [CSE421 - Algorithm Analysis](https://github.com/RD-Bhowmik/CSE421)
Advanced algorithms and computational complexity coursework.

#### [CSE420 - Compiler Design](https://github.com/RD-Bhowmik/CSE420)
Compiler construction and programming language theory.

#### [CSE321 Lab - Operating Systems](https://github.com/RD-Bhowmik/cse321_Lab)
Operating systems lab assignments and implementations.

#### [UniFlow - Database Project](https://github.com/RD-Bhowmik/project370_UniFlow)
Database management system project with comprehensive data modeling.
